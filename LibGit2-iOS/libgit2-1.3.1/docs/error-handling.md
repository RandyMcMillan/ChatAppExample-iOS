...
- Use proper English, and an impersonal or past tenses: _The given path
  does not exist_, _Failed to lookup object in ODB_
...
- In general, _do not_ try to overwrite errors internally and _do_
